          ...
          >
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-8">
              ...
              <div className="hidden md:flex items-center gap-2">
                ...
                <Button size="sm">Try Beta Version</Button>
              </div>
            </div>
              ...
              >
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                  <div className="space-y-4 order-2 md:order-1">
                    ...
                    <Card className="overflow-hidden border border-muted/30 bg-background/50 backdrop-blur-sm">
                          ...
                          {feature.id === "trading" && (
                            <>
                              ...
                              <li className="flex items-center gap-2">
                                <div className="h-2 w-2 rounded-full bg-primary"></div>
                                <span>
                                  Limit and market orders with low fees
                                </span>
                              </li>
                              <li className="flex items-center gap-2">
                                <div className="h-2 w-2 rounded-full bg-primary"></div>
                                <span>
                                  NFT liquidity positions for optimal yields
                                </span>
                              </li>
                            </>
                          )}
                          {feature.id === "bridge" && (
                            <>
                              ...
                              <li className="flex items-center gap-2">
                                <div className="h-2 w-2 rounded-full bg-primary"></div>
                                <span>
                                  Fast confirmation times and low fees
                                </span>
                              </li>
                              <li className="flex items-center gap-2">
                                <div className="h-2 w-2 rounded-full bg-primary"></div>
                  ...
                  <div className="relative order-1 md:order-2">
                    <div className="aspect-video overflow-hidden rounded-lg border border-muted/30 bg-muted/10 shadow-xl">
                      <img
                    ...
                    <div className="absolute -bottom-4 -right-4 bg-primary/10 backdrop-blur-md border border-primary/20 rounded-lg p-3 shadow-lg">
                      <div className="text-sm font-medium">Coming Q3 2023</div>
                    </div>
                  </div>
                </div>
              </TabsContent>
